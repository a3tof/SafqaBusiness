...
void main() async {
  ...
  for (int i = 1; i <= 6; i++) {
    try {
      final request = await client.getUrl(Uri.parse('https://e-safqa.runasp.net/api/Auction/Get-Attributes/$i'));
      ...
      if (response.statusCode == 200) {
        ...
        print('Required: ${requiredAttrs.isEmpty ? "None" : requiredAttrs.join(', ')}');
        print('Not Required: ${optionalAttrs.isEmpty ? "None" : optionalAttrs.join(', ')}');
      } else {
