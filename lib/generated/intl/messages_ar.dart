...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m16(count) => "حذف ${count} إشعار محدد؟";

  static String m17(count) => "منذ ${count} ساعة";

  static String m18(count) => "منذ ${count} دقيقة";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "auctionPreviousItem": MessageLookupByLibrary.simpleMessage(
      "العنصر السابق",
    ),
    ...
    "chatTypeMessage": MessageLookupByLibrary.simpleMessage("اكتب رسالة..."),
    "chatYou": MessageLookupByLibrary.simpleMessage("أنت"),
    ...
    "kDarkMode": MessageLookupByLibrary.simpleMessage("الوضع الداكن"),
    ...
    "kEnterWithdrawalAmo": MessageLookupByLibrary.simpleMessage(
      "أدخل مبلغ السحب",
    ),
    ...
    "kLegalDocuments": MessageLookupByLibrary.simpleMessage(
      "المستندات القانونية",
    ),
    "kLegalDocumentsAre": MessageLookupByLibrary.simpleMessage(
      "الوثائق القانونية مفقودة. يرجى العودة.",
    ),
    "kLightMode": MessageLookupByLibrary.simpleMessage("الوضع الفاتح"),
    "kLocalAccountNumber": MessageLookupByLibrary.simpleMessage(
      "رقم الحساب المحلي (اختياري)",
    ),
    "kLoginSuccessful": MessageLookupByLibrary.simpleMessage(
      "تسجيل الدخول ناجح!",
    ),
    ...
    "kPleaseSelectABank": MessageLookupByLibrary.simpleMessage(
      "يرجى اختيار بنك",
    ),
    "kPleaseSelectACoun": MessageLookupByLibrary.simpleMessage(
      "يرجى اختيار دولة ومدينة",
    ),
    "kPleaseUploadAllFo": MessageLookupByLibrary.simpleMessage(
      "يرجى رفع كافة المستندات الأربعة",
    ),
    ...
    "kStatistics": MessageLookupByLibrary.simpleMessage("الإحصائيات"),
    "kStoreDescription": MessageLookupByLibrary.simpleMessage("وصف المتجر"),
    "kStoreInformation": MessageLookupByLibrary.simpleMessage("معلومات المتجر"),
    "kStoreLogoOptional": MessageLookupByLibrary.simpleMessage(
      "شعار المتجر (اختياري)",
    ),
    ...
    "kTransactionHistory": MessageLookupByLibrary.simpleMessage(
      "سجل المعاملات",
    ),
    ...
    "kUploadNationalId": MessageLookupByLibrary.simpleMessage(
      "رفع الهوية الوطنية (الوجه)",
    ),
    "kUploadOwner": MessageLookupByLibrary.simpleMessage(
      "رفع بطاقة الهوية للمالك (الوجه)",
    ),
    "kUploadOwners": MessageLookupByLibrary.simpleMessage(
      "رفع بطاقة الهوية للمالك",
    ),
    "kUploadTaxId": MessageLookupByLibrary.simpleMessage(
      "رفع البطاقة الضريبية",
    ),
    "kWallet": MessageLookupByLibrary.simpleMessage("المحفظة"),
    "kWithdrawal": MessageLookupByLibrary.simpleMessage("سحب"),
    "kWithdrawalNmoney": MessageLookupByLibrary.simpleMessage("سحب\\nالمال"),
    ...
    "notificationsDeleteSelectionConfirm": m16,
    "notificationsEmpty": MessageLookupByLibrary.simpleMessage(
      "لا توجد إشعارات حتى الآن",
    ),
    "notificationsHoursAgo": m17,
    ...
    "termsAccountUsageTitle": MessageLookupByLibrary.simpleMessage(
      "استخدام الحساب",
    ),
    ...
    "termsAuctionMgmtTitle": MessageLookupByLibrary.simpleMessage(
      "إدارة المزادات",
    ),
    ...
    "termsBiddingRulesTitle": MessageLookupByLibrary.simpleMessage(
      "قواعد المزايدة",
    ),
    "termsBindingBids": MessageLookupByLibrary.simpleMessage(
      "جميع العروض المقدمة على المنصة ملزمة قانونيًا ولا يمكن سحبها.",
    ),
    "termsBuyerAge": MessageLookupByLibrary.simpleMessage(
      "يجب أن يكون عمر المشتري 18 عامًا على الأقل لإنشاء حساب والمشاركة في المزادات.",
    ),
    "termsBuyerAppTitle": MessageLookupByLibrary.simpleMessage("تطبيق المشتري"),
    "termsBuyerCredentials": MessageLookupByLibrary.simpleMessage(
      "يتحمل المشترون مسؤولية الحفاظ على سرية بيانات اعتماد حساباتهم.",
    ),
    "termsBuyerMultipleAccounts": MessageLookupByLibrary.simpleMessage(
      "يُحظر تمامًا إنشاء حسابات متعددة لنفس الشخص.",
    ),
    "termsChangesTitle": MessageLookupByLibrary.simpleMessage(
      "التغييرات على الشروط",
    ),
    "termsContinuedUse": MessageLookupByLibrary.simpleMessage(
      "يُعد الاستمرار في استخدام المنصة بعد أي تغييرات قبولًا للشروط المحدثة.",
    ),
    "termsDataCollected": MessageLookupByLibrary.simpleMessage(
      "تجمع صفقة البيانات الشخصية بما في ذلك الاسم والبريد الإلكتروني ورقم الهاتف وسجل المعاملات.",
    ),
    "termsDataProtected": MessageLookupByLibrary.simpleMessage(
    ...
    "termsFeesTitle": MessageLookupByLibrary.simpleMessage("الرسوم"),
    "termsHighestBidWins": MessageLookupByLibrary.simpleMessage(
      "يفوز بالعنصر أعلى عرض سعر عند إغلاق المزاد.",
    ),
    "termsHonestDescriptions": MessageLookupByLibrary.simpleMessage(
      "يجب على البائعين تقديم أوصاف صادقة ودقيقة لجميع العناصر المدرجة للمزاد.",
    ),
    "termsIntermediary": MessageLookupByLibrary.simpleMessage(
      "تعمل صفقة كوسيط فقط بين المشترين والبائعين ولا تضمن نتائج المعاملات.",
    ),
    "termsLiabilityTitle": MessageLookupByLibrary.simpleMessage("المسؤولية"),
    "termsManipulateBids": MessageLookupByLibrary.simpleMessage(
      "يُحظر تمامًا أي محاولة للتلاعب في العروض أو التواطؤ مع مزايدين آخرين.",
    ),
    "termsMonitored": MessageLookupByLibrary.simpleMessage(
      "تتم مراقبة جميع الأنشطة على المنصة لضمان الامتثال والأمان.",
    ),
    "termsNoModifyActive": MessageLookupByLibrary.simpleMessage(
    ...
    "termsNotifPolicyTitle": MessageLookupByLibrary.simpleMessage(
      "سياسة الإشعارات",
    ),
    ...
    "termsPrivacyDataTitle": MessageLookupByLibrary.simpleMessage(
      "الخصوصية والبيانات",
    ),
    "termsProxyBiddingRules": MessageLookupByLibrary.simpleMessage(
      "تتيح المزايدة التلقائية للنظام تقديم العروض نيابةً عنك حتى حدك الأقصى.",
    ),
    "termsRaiseDisputes": MessageLookupByLibrary.simpleMessage(
      "يمكن للمشترين رفع نزاع خلال 48 ساعة من استلام منتج لا يطابق الوصف.",
    ),
    "termsRefundsPolicy": MessageLookupByLibrary.simpleMessage(
      "تتم معالجة المبالغ المستردة في غضون 7 أيام عمل بعد حل نزاع صالح لصالح المشتري.",
    ),
    "termsReviewNotif": MessageLookupByLibrary.simpleMessage(
      "يتحمل المستخدمون مسؤولية مراجعة جميع الإشعارات واتخاذ الإجراء المناسب في الوقت المناسب.",
    ),
    "termsSecurityDeposits": MessageLookupByLibrary.simpleMessage(
    ...
    "termsSellerAppTitle": MessageLookupByLibrary.simpleMessage("تطبيق البائع"),
    "termsSellerApproval": MessageLookupByLibrary.simpleMessage(
      "تخضع حسابات البائعين لموافقة فريق صفقة قبل تفعيلها.",
    ),
    "termsSellerRegTitle": MessageLookupByLibrary.simpleMessage("تسجيل البائع"),
    ...
    "termsSuspendAccounts": MessageLookupByLibrary.simpleMessage(
      "تحتفظ صفقة بالحق في تعليق أو إنهاء الحسابات التي تنتهك هذه الشروط.",
    ),
    "termsTimelyDelivery": MessageLookupByLibrary.simpleMessage(
      "يلتزم البائعون بتسليم العناصر للمشترين الفائزين في الإطار الزمني المتفق عليه.",
    ),
    "termsTrackEarnings": MessageLookupByLibrary.simpleMessage(
